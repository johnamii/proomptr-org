<div class='w-full bg-neutral-900 text-white flex items-center justify-evenly p-4'>
    ...
    <div class='flex items-center gap-4'>
        ...
        <img class='h-6' src='https://th.bing.com/th?id=ODLS.3daef3e1-47c6-4e84-9cd0-84259575a155&w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2' alt='electron'/>
        <img class='h-6' src='https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/GPT-4.png/640px-GPT-4.png' alt='openai'/>
    </div>
</div>